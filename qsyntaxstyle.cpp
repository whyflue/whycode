...
QSyntaxStyle* QSyntaxStyle::defaultStyle()
{
    ...
    if (!style.isLoaded())
    {
        ...
        QFile fl(":/resources/gui/themes/default.xml");
...
QSyntaxStyle* QSyntaxStyle::defaultLight()
{
    static QSyntaxStyle style;
    ...
    {
        Q_INIT_RESOURCE(qcodeeditor_resources);
        QFile fl(":/resources/gui/themes/default_whylightmode.xml");
        ...
        if (!style.load(fl.readAll()))
        {
            qDebug() << "Can't load style.";
        }
    }

    return &style;
}
QSyntaxStyle* QSyntaxStyle::psichoStyle()
{
    static QSyntaxStyle style;
    ...
    {
        Q_INIT_RESOURCE(qcodeeditor_resources);
        QFile fl(":/resources/gui/themes/psicho.xml");
